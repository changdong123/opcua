...
public class ExampleServer {
    ...
    public static void main(String[] args) throws Exception {
        ...
        /*server.exampleNamespace.addLifecycle();*/
        //添加根节点
        //UaNode folderNode = server.exampleNamespace.createAndAddNodes("product4");

        NodeId nodeId = new NodeId(2, "product1");
        AddressSpaceManager addressSpaceManager = server.getServer().getAddressSpaceManager();//getManagedNode(nodeId).get().getNodeManager().addNode(folderNode);
        UaFolderNode uaNode = (UaFolderNode) addressSpaceManager.getManagedNode(nodeId).get();
        //server.exampleNamespace.addNodeInGroup(uaNode, "changdong", "chang", null, null);
       /* UaNode contentNode = server.exampleNamespace.addWriteOnlyNodes(uaNode, "device100", "device100");
        NodeManager<UaNode> nodeNodeManager = uaNode.getNodeManager();
        nodeNodeManager.addNode(contentNode);*/
    ...
    public ExampleServer() throws Exception {
        ...
        OpcUaServerConfig serverConfig = OpcUaServerConfig.builder()
                ...
                .setHttpsCertificate(new X509Certificate[]{httpsCertificate}[0])
